...
document.addEventListener('DOMContentLoaded', function() {
    ...
    wavesurfer.util
        ...
        .on('success', function(data) {
            ...
            //var mediaElt = 'https://ia601307.us.archive.org/14/items/SylviaPlathOnThePlethoraOfDryads/Perseus-The%20Triumph%20Of%20Wit%20Over%20Suffering.mp3';
...
window.GLOBAL_ACTIONS['delete-region'] = function() {
    ...
    //console.log( "want to remove region");
    if (regionId) {
